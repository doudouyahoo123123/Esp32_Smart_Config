...
ANDROID_NDK_ROOT=/Users/euclideonchina/Downloads/Android/android-ndk-r13b
...
ANDROID_TOOLCHAIN=/Users/euclideonchina/Downloads/Android/android-ndk-r13b/toolchains
...
do
  # Error checking
  if [ ! -e "/Users/euclideonchina/Downloads/Android/android-ndk-r13b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/$tool" ]; then
